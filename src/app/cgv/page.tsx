...
export const metadata: Metadata = {
  title: "Conditions Générales de Vente | WebCraft Studio",
  description: "Conditions générales de vente de WebCraft Studio, agence web à Strasbourg.",
};
        ...
        {[
          {
            ...
            content:
              "Les présentes conditions générales de vente régissent les relations contractuelles entre WebCraft Studio (ci-après « le Prestataire ») et ses clients (ci-après « le Client ») dans le cadre de prestations de création de sites internet, de maintenance et de services associés.",
          },
          {
