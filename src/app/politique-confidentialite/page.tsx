...
export const metadata: Metadata = {
  title: "Politique de confidentialité | WebCraft Studio",
  description: "Politique de confidentialité et protection des données personnelles de WebCraft Studio.",
};
    ...
    <section className="pt-32 pb-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10">
          ...
          <p className="mt-3 text-[#6B7280] leading-relaxed">
            Conformément au RGPD, vous disposez des droits suivants : droit d&apos;accès, de rectification, d&apos;effacement, de limitation du traitement, de portabilité des données et d&apos;opposition. Pour exercer ces droits, contactez-nous par e-mail à contact@webcraft-studio.fr ou par courrier à l&apos;adresse : WebCraft Studio, 15 Place Kléber, 67000 Strasbourg.
          </p>
        </div>
        ...
        <div className="mt-10">
          ...
          <p className="mt-3 text-[#6B7280] leading-relaxed">
            Pour toute question relative à la protection de vos données personnelles, vous pouvez contacter notre délégué à la protection des données à l&apos;adresse : dpo@webcraft-studio.fr. Vous disposez également du droit d&apos;introduire une réclamation auprès de la CNIL (Commission Nationale de l&apos;Informatique et des Libertés).
          </p>
        </div>
      </div>
    </section>
