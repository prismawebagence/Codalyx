...
export const metadata: Metadata = {
  title: "À propos | WebCraft Studio — Agence Web Strasbourg",
  description:
    "Découvrez WebCraft Studio, agence web basée à Strasbourg. Notre mission : rendre le web accessible aux artisans et PME d'Alsace avec des sites performants.",
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-[#6B7280]">
              WebCraft Studio est née d&apos;un constat simple : trop d&apos;artisans, de
          ...
          <div className="mx-auto mt-16 max-w-3xl space-y-6 text-[#0A0A0A]">
            <p className="leading-relaxed">
              Fondée à Strasbourg, notre agence accompagne les entreprises
              locales dans leur transformation digitale. Nous ne sommes pas une
              agence de plus qui vend des templates génériques. Chaque site que
              nous créons est pensé pour <strong>un métier</strong>, <strong>un territoire</strong> et <strong>des clients précis</strong>.
            </p>
            <p className="leading-relaxed">
          ...
          <div className="mt-24 rounded-2xl bg-[#FAFAFA] p-8 md:p-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-[#6B7280]">
              Notre bureau est situé au 15 Place Kléber, en plein cœur de
              Strasbourg. Nous intervenons dans toute l&apos;Alsace et le Grand Est,
